#[doc = "Reader of register ESC_CONF1"]
pub type R = crate::R<u32, super::ESC_CONF1>;
#[doc = "Writer for register ESC_CONF1"]
pub type W = crate::W<u32, super::ESC_CONF1>;
#[doc = "Register ESC_CONF1 `reset()`'s with value 0"]
impl crate::ResetValue for super::ESC_CONF1 {
    type Type = u32;
    #[inline(always)]
