#[doc = "Reader of register SPIHD"]
pub type R = crate::R<u32, super::SPIHD>;
#[doc = "Writer for register SPIHD"]
pub type W = crate::W<u32, super::SPIHD>;
#[doc = "Register SPIHD `reset()`'s with value 0x0a00"]
impl crate::ResetValue for super::SPIHD {
    type Type = u32;
    #[inline(always)]
