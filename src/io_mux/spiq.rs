#[doc = "Reader of register SPIQ"]
pub type R = crate::R<u32, super::SPIQ>;
#[doc = "Writer for register SPIQ"]
pub type W = crate::W<u32, super::SPIQ>;
#[doc = "Register SPIQ `reset()`'s with value 0x1b00"]
impl crate::ResetValue for super::SPIQ {
    type Type = u32;
    #[inline(always)]
