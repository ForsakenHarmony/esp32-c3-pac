#[doc = "Reader of register SPICLK"]
pub type R = crate::R<u32, super::SPICLK>;
#[doc = "Writer for register SPICLK"]
pub type W = crate::W<u32, super::SPICLK>;
#[doc = "Register SPICLK `reset()`'s with value 0x1b00"]
impl crate::ResetValue for super::SPICLK {
    type Type = u32;
    #[inline(always)]
