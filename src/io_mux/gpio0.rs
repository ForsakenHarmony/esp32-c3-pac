#[doc = "Reader of register GPIO0"]
pub type R = crate::R<u32, super::GPIO0>;
#[doc = "Writer for register GPIO0"]
pub type W = crate::W<u32, super::GPIO0>;
#[doc = "Register GPIO0 `reset()`'s with value 0x0800"]
impl crate::ResetValue for super::GPIO0 {
    type Type = u32;
    #[inline(always)]
