#[doc = "Reader of register MTMS"]
pub type R = crate::R<u32, super::MTMS>;
#[doc = "Writer for register MTMS"]
pub type W = crate::W<u32, super::MTMS>;
#[doc = "Register MTMS `reset()`'s with value 0x0a00"]
impl crate::ResetValue for super::MTMS {
    type Type = u32;
    #[inline(always)]
