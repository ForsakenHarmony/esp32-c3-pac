#[doc = "Reader of register GPIO8"]
pub type R = crate::R<u32, super::GPIO8>;
#[doc = "Writer for register GPIO8"]
pub type W = crate::W<u32, super::GPIO8>;
#[doc = "Register GPIO8 `reset()`'s with value 0x0a80"]
impl crate::ResetValue for super::GPIO8 {
    type Type = u32;
    #[inline(always)]
