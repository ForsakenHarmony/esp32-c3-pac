#[doc = "Reader of register GPIO3"]
pub type R = crate::R<u32, super::GPIO3>;
#[doc = "Writer for register GPIO3"]
pub type W = crate::W<u32, super::GPIO3>;
#[doc = "Register GPIO3 `reset()`'s with value 0x0800"]
impl crate::ResetValue for super::GPIO3 {
    type Type = u32;
    #[inline(always)]
