#[doc = "Reader of register MTDO"]
pub type R = crate::R<u32, super::MTDO>;
#[doc = "Writer for register MTDO"]
pub type W = crate::W<u32, super::MTDO>;
#[doc = "Register MTDO `reset()`'s with value 0x0b00"]
impl crate::ResetValue for super::MTDO {
    type Type = u32;
    #[inline(always)]
