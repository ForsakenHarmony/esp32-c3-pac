#[doc = "Reader of register GPIO9"]
pub type R = crate::R<u32, super::GPIO9>;
#[doc = "Writer for register GPIO9"]
pub type W = crate::W<u32, super::GPIO9>;
#[doc = "Register GPIO9 `reset()`'s with value 0x0b00"]
impl crate::ResetValue for super::GPIO9 {
    type Type = u32;
    #[inline(always)]
