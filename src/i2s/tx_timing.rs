#[doc = "Reader of register TX_TIMING"]
pub type R = crate::R<u32, super::TX_TIMING>;
#[doc = "Writer for register TX_TIMING"]
pub type W = crate::W<u32, super::TX_TIMING>;
#[doc = "Register TX_TIMING `reset()`'s with value 0"]
impl crate::ResetValue for super::TX_TIMING {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `TX_BCK_IN_DM`"]
pub type TX_BCK_IN_DM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TX_BCK_IN_DM`"]
...
#[doc = "Reader of field `TX_WS_IN_DM`"]
pub type TX_WS_IN_DM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TX_WS_IN_DM`"]
...
#[doc = "Reader of field `TX_BCK_OUT_DM`"]
pub type TX_BCK_OUT_DM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TX_BCK_OUT_DM`"]
...
#[doc = "Reader of field `TX_WS_OUT_DM`"]
pub type TX_WS_OUT_DM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TX_WS_OUT_DM`"]
...
#[doc = "Reader of field `TX_SD1_OUT_DM`"]
pub type TX_SD1_OUT_DM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TX_SD1_OUT_DM`"]
...
#[doc = "Reader of field `TX_SD_OUT_DM`"]
pub type TX_SD_OUT_DM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TX_SD_OUT_DM`"]
