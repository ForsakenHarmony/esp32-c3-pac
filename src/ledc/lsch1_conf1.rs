#[doc = "Reader of register LSCH1_CONF1"]
pub type R = crate::R<u32, super::LSCH1_CONF1>;
#[doc = "Writer for register LSCH1_CONF1"]
pub type W = crate::W<u32, super::LSCH1_CONF1>;
#[doc = "Register LSCH1_CONF1 `reset()`'s with value 0"]
impl crate::ResetValue for super::LSCH1_CONF1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `DUTY_START_LSCH1`"]
pub type DUTY_START_LSCH1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DUTY_START_LSCH1`"]
...
#[doc = "Reader of field `DUTY_INC_LSCH1`"]
pub type DUTY_INC_LSCH1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DUTY_INC_LSCH1`"]
...
#[doc = "Reader of field `DUTY_NUM_LSCH1`"]
pub type DUTY_NUM_LSCH1_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `DUTY_NUM_LSCH1`"]
...
#[doc = "Reader of field `DUTY_CYCLE_LSCH1`"]
pub type DUTY_CYCLE_LSCH1_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `DUTY_CYCLE_LSCH1`"]
...
#[doc = "Reader of field `DUTY_SCALE_LSCH1`"]
pub type DUTY_SCALE_LSCH1_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `DUTY_SCALE_LSCH1`"]
