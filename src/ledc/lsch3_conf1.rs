#[doc = "Reader of register LSCH3_CONF1"]
pub type R = crate::R<u32, super::LSCH3_CONF1>;
#[doc = "Writer for register LSCH3_CONF1"]
pub type W = crate::W<u32, super::LSCH3_CONF1>;
#[doc = "Register LSCH3_CONF1 `reset()`'s with value 0"]
impl crate::ResetValue for super::LSCH3_CONF1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `DUTY_START_LSCH3`"]
pub type DUTY_START_LSCH3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DUTY_START_LSCH3`"]
...
#[doc = "Reader of field `DUTY_INC_LSCH3`"]
pub type DUTY_INC_LSCH3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DUTY_INC_LSCH3`"]
...
#[doc = "Reader of field `DUTY_NUM_LSCH3`"]
pub type DUTY_NUM_LSCH3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `DUTY_NUM_LSCH3`"]
...
#[doc = "Reader of field `DUTY_CYCLE_LSCH3`"]
pub type DUTY_CYCLE_LSCH3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `DUTY_CYCLE_LSCH3`"]
...
#[doc = "Reader of field `DUTY_SCALE_LSCH3`"]
pub type DUTY_SCALE_LSCH3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `DUTY_SCALE_LSCH3`"]
