#[doc = "Writer for register INT_ENA_W1TS"]
pub type W = crate::W<u32, super::INT_ENA_W1TS>;
#[doc = "Register INT_ENA_W1TS `reset()`'s with value 0"]
impl crate::ResetValue for super::INT_ENA_W1TS {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `BBPLL_CAL_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `GLITCH_DET_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `XTAL32K_DEAD_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `SWD_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `MAIN_TIMER_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `BROWN_OUT_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `WDT_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `SLP_REJECT_INT_ENA_W1TS`"]
...
#[doc = "Write proxy for field `SLP_WAKEUP_INT_ENA_W1TS`"]
