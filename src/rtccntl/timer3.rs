...
#[doc = "Reader of field `BT_POWERUP_TIMER`"]
pub type BT_POWERUP_TIMER_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `BT_POWERUP_TIMER`"]
...
#[doc = "Reader of field `BT_WAIT_TIMER`"]
pub type BT_WAIT_TIMER_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `BT_WAIT_TIMER`"]
