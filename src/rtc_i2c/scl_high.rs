#[doc = "Reader of register SCL_HIGH"]
pub type R = crate::R<u32, super::SCL_HIGH>;
#[doc = "Writer for register SCL_HIGH"]
pub type W = crate::W<u32, super::SCL_HIGH>;
#[doc = "Register SCL_HIGH `reset()`'s with value 0"]
impl crate::ResetValue for super::SCL_HIGH {
    type Type = u32;
    #[inline(always)]
