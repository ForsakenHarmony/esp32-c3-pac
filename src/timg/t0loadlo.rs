#[doc = "Reader of register T0LOADLO"]
pub type R = crate::R<u32, super::T0LOADLO>;
#[doc = "Writer for register T0LOADLO"]
pub type W = crate::W<u32, super::T0LOADLO>;
#[doc = "Register T0LOADLO `reset()`'s with value 0"]
impl crate::ResetValue for super::T0LOADLO {
    type Type = u32;
    #[inline(always)]
