#[doc = "Reader of register WDTCONFIG4"]
pub type R = crate::R<u32, super::WDTCONFIG4>;
#[doc = "Writer for register WDTCONFIG4"]
pub type W = crate::W<u32, super::WDTCONFIG4>;
#[doc = "Register WDTCONFIG4 `reset()`'s with value 0"]
impl crate::ResetValue for super::WDTCONFIG4 {
    type Type = u32;
    #[inline(always)]
