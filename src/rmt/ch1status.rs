#[doc = "Reader of register CH1STATUS"]
pub type R = crate::R<u32, super::CH1STATUS>;
#[doc = "Reader of field `APB_MEM_RADDR_CH1`"]
pub type APB_MEM_RADDR_CH1_R = crate::R<u8, u8>;
#[doc = "Reader of field `APB_MEM_WR_ERR_CH1`"]
pub type APB_MEM_WR_ERR_CH1_R = crate::R<bool, bool>;
#[doc = "Reader of field `MEM_EMPTY_CH1`"]
pub type MEM_EMPTY_CH1_R = crate::R<bool, bool>;
#[doc = "Reader of field `APB_MEM_RD_ERR_CH1`"]
pub type APB_MEM_RD_ERR_CH1_R = crate::R<bool, bool>;
#[doc = "Reader of field `APB_MEM_WADDR_CH1`"]
pub type APB_MEM_WADDR_CH1_R = crate::R<u16, u16>;
#[doc = "Reader of field `STATE_CH1`"]
pub type STATE_CH1_R = crate::R<u8, u8>;
#[doc = "Reader of field `MEM_RADDR_EX_CH1`"]
pub type MEM_RADDR_EX_CH1_R = crate::R<u16, u16>;
impl R {
    #[doc = "Bits 24:31"]
    #[inline(always)]
